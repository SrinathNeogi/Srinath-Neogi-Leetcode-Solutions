...
//----------------------------------------METHOD 2 ---------------------------------------------
//Better method, no need of extra 2 array, pge is modified into nge , minimum element array simultaneously.
class Solution {
public:
    int trap(vector<int>& height) {
        int water_amount = 0;
        ...
        //Finding NGE Array using PGE , this will work as main array as well.
